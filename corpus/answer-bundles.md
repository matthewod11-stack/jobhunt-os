...
**Stop line:** That's the arc. Happy to go deep on any chapter.

## Why did you leave Brightline?

**Principle:** A layoff is one sentence, not a story. Over-explaining a restructure makes it sound like it needs explaining.

**What I've done:** Brightline cut 40% of go-to-market in the January 2026 restructure and my role went with it. The lifecycle system I built is still running, owned by a marketer I trained, which is the exit I'd have wanted anyway.

**What I'd do now:** Nothing different in the telling. I'm using the search to be deliberate about the next role: one where marketing owns a number, not a calendar of deliverables.

**Stop line:** Plainly: the company shrank, the work held up, and now I'm talking to you.

## Tell me about a bet that worked
...
**Stop line:** The freed spend funded the email program behind the repeat-purchase gains, so one bet paid twice.

## How do you work with product and engineering?

**Principle:** Marketing earns its seat with product by bringing customer evidence, not opinions.
